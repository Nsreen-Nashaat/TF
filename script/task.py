...
def cb1 ():
    ...
    flag1 += 1
    if (flag1 == 1):
        goal_z = 0.4054545538982096 - (0.025 + 0.03)

        target.pose.position.x = 0.4738468155487005 - 0.25 + 0.015
        target.pose.position.y = 0.0604760852166315
...
def cb2 ():
    ...
    flag2 += 1
    if (flag2 == 1):
        goal_z = 0.4052581061654696 - (0.025 + 0.03)
...
def cb3 ():
    ...
    flag3 += 1
    if (flag3 == 1):
        goal_z = 0.2181650487864888 - (0.02 + 0.03)

        target.pose.position.x = 0.47371703242868823 - 0.25 + 0.015
        target.pose.position.y = 0.06015966436477865
        target.pose.position.z = goal_z
...
def cb4 ():
    ...
    flag4 += 1
    if (flag4 == 1):
        goal_z = 0.22420270520428232 - (0.02 + 0.03)

        target.pose.position.x = 0.47878328030344575 - 0.25 + 0.015
        target.pose.position.y = -0.05894758808087752
        target.pose.position.z = goal_z
